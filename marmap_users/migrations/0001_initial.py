...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'marmap_users_mobuserstatus', (
            ...
            ('location_fix', self.gf('django.db.models.fields.related.OneToOneField')(related_name='location_of', to_field='uuid', unique=True, to=orm['marmap_users.LocationFix'])),
        ...
        db.create_table(u'marmap_users_mobuserprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='profile', unique=True, to=orm['auth.User'])),
            ('user_status', self.gf('django.db.models.fields.related.OneToOneField')(related_name='status_of', unique=True, null=True, to=orm['marmap_users.MobUserStatus'])),
        ))
        db.send_create_signal(u'marmap_users', ['MobUserProfile'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'marmap_users_mobuserprofile')
    ...
    models = {
        ...
        u'marmap_users.mobuserprofile': {
            'Meta': {'object_name': 'MobUserProfile'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'profile'", 'unique': 'True', 'to': u"orm['auth.User']"}),
            'user_status': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'status_of'", 'unique': 'True', 'null': 'True', 'to': u"orm['marmap_users.MobUserStatus']"})
        },
        u'marmap_users.mobuserstatus': {
            'Meta': {'object_name': 'MobUserStatus'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location_fix': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'location_of'", 'to_field': "'uuid'", 'unique': 'True', 'to': u"orm['marmap_users.LocationFix']"}),
