...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'LocationFix', fields ['uuid']
        db.create_unique(u'marmap_users_locationfix', ['uuid'])


        # Changing field 'MobUserStatus.location_fix'
        db.alter_column(u'marmap_users_mobuserstatus', 'location_fix_id', self.gf('django.db.models.fields.related.ForeignKey')(to_field='uuid', to=orm['marmap_users.LocationFix']))

    def backwards(self, orm):
        # Removing unique constraint on 'LocationFix', fields ['uuid']
        db.delete_unique(u'marmap_users_locationfix', ['uuid'])


        # Changing field 'MobUserStatus.location_fix'
        db.alter_column(u'marmap_users_mobuserstatus', 'location_fix_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['marmap_users.LocationFix']))
    ...
    models = {
        ...
        u'marmap_users.mobuserstatus': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location_fix': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'location_of'", 'to_field': "'uuid'", 'to': u"orm['marmap_users.LocationFix']"}),
